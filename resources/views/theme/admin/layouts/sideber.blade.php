    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{route('doctor.list')}}"><i
                            class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Doctor</span></a>
                </li>
                <li class="sub-category">
                    <h3>UI Kit</h3>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                            class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Setting</span><i
                            class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Setting</a></li>
                        <li><a href="{{ route('speciality.list') }}" class="slide-item">Speciality</a></li>
                        <li><a href="{{ route('division.list') }}" class="slide-item">Division</a></li>
                        <li><a href="{{ route('smsGateway.list') }}" class="slide-item">Sms Gateway</a></li>
